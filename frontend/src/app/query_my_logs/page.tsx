          ...
          <>
            ...
            <div className="w-full max-w-2xl mx-auto">
              <div className="text-center mb-8">
                ...
                <h1 className="text-white text-3xl font-bold mb-4">What would you like to explore?</h1>
                <p className="text-gray-300 text-lg">
          ...
          <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-3 px-8 rounded-2xl transition-all duration-200 transform hover:scale-105 flex items-center gap-2 mx-auto"
              >
